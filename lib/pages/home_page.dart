  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:
            Color.fromARGB(255, 255, 255, 255), // Cor de fundo do AppBar
      ),
      drawer: CustomDrawer(),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  // Botões de navegação
                  _buildCardButton(
                      context, 'Modelos Prontos', ModelsPage(), Icons.house),
                  SizedBox(height: 20),
                  _buildCardButton(
                      context, 'Modelos Básicos', Mbasico(), Icons.handshake),
                  SizedBox(height: 20),
                  _buildCardButton(context, 'Projetos Modificados',
                      Modificados(), Icons.build),
                  SizedBox(height: 20),
                  _buildCardButton(
                      context, 'Projetos Personalizados', lobby(), Icons.edit),
                  SizedBox(height: 80),
                  _buildCardButton(
                      context, 'Ideias', IdeiasPage(), Icons.lightbulb_outline),
                  SizedBox(height: 20),
                ],
              ),
            ),
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(icon,
                  size: 30, color: Color(0xFFFF9A00)), // Ícone ao lado do texto
