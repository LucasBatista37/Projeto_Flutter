  ...
  final List<Map<String, String>> ideiasSemanais = [
    {
      ...
      'descricao':
          'Projetos inovadores focados em sustentabilidade e economia de energia.',
      'imagem': 'assets/images/sus.jpg',
    },
    {
      'titulo': 'Estúdio Moderno',
      'descricao': 'Espaço compacto e funcional para artistas e freelancers.',
      'imagem': 'assets/images/studio.jpg',
    },
    {
      'titulo': 'Área de Convivência Urbana',
      'descricao':
          'Projetos que promovem interação social e lazer nas cidades.',
      'imagem': 'assets/images/area.jpg',
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(
              Icons.arrow_back), // Aqui você pode usar o ícone que preferir
          onPressed: () {
